...
type MediaXPluginRedBook struct {
	PluginName string
	Logger     *logger.Logger
}

func NewMediaXPluginRedBook() MediaXPluginRedBook {
	return MediaXPluginRedBook{
		PluginName: string(contract.RedBook),
	}
}

func (p *MediaXPluginRedBook) Initialize(ctx *context.Context, arg interface{}) error {
...
func (p *MediaXPluginRedBook) Name(ctx *context.Context) string {
	return p.PluginName
}

func (p *MediaXPluginRedBook) Publish(ctx *context.Context, arg interface{}) (interface{}, error) {
...
var RedBook MediaXPluginRedBook = NewMediaXPluginRedBook()
